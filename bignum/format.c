...
static const struct {
    ...
    /*  0 */ {U64_C(0x0000000000000000), 0},
    /*  1 */ {U64_C(0x0000000000000000), 0},
    /*  2 */ {U64_C(0x8000000000000000), 63},
    /*  3 */ {U64_C(0xA8B8B452291FE821), 40},
    /*  4 */ {U64_C(0x4000000000000000), 31},
    /*  5 */ {U64_C(0x6765C793FA10079D), 27},
    /*  6 */ {U64_C(0x41C21CB8E1000000), 24},
    /*  7 */ {U64_C(0x3642798750226111), 22},
    /*  8 */ {U64_C(0x8000000000000000), 21},
    /*  9 */ {U64_C(0xA8B8B452291FE821), 20},
    /* 10 */ {U64_C(0x8AC7230489E80000), 19},
    /* 11 */ {U64_C(0x4D28CB56C33FA539), 18},
    /* 12 */ {U64_C(0x1ECA170C00000000), 17},
    /* 13 */ {U64_C(0x780C7372621BD74D), 17},
    /* 14 */ {U64_C(0x1E39A5057D810000), 16},
    /* 15 */ {U64_C(0x5B27AC993DF97701), 16},
    /* 16 */ {U64_C(0x1000000000000000), 15},
    /* 17 */ {U64_C(0x27B95E997E21D9F1), 15},
    /* 18 */ {U64_C(0x5DA0E1E53C5C8000), 15},
    /* 19 */ {U64_C(0xD2AE3299C1C4AEDB), 15},
    /* 20 */ {U64_C(0x16BCC41E90000000), 14},
    /* 21 */ {U64_C(0x2D04B7FDD9C0EF49), 14},
    /* 22 */ {U64_C(0x5658597BCAA24000), 14},
    /* 23 */ {U64_C(0xA0E2073737609371), 14},
    /* 24 */ {U64_C(0x0C29E98000000000), 13},
    /* 25 */ {U64_C(0x14ADF4B7320334B9), 13},
    /* 26 */ {U64_C(0x226ED36478BFA000), 13},
    /* 27 */ {U64_C(0x383D9170B85FF80B), 13},
    /* 28 */ {U64_C(0x5A3C23E39C000000), 13},
    /* 29 */ {U64_C(0x8E65137388122BCD), 13},
    /* 30 */ {U64_C(0xDD41BB36D259E000), 13},
    /* 31 */ {U64_C(0x0AEE5720EE830681), 12},
    /* 32 */ {U64_C(0x1000000000000000), 12},
    /* 33 */ {U64_C(0x172588AD4F5F0981), 12},
    /* 34 */ {U64_C(0x211E44F7D02C1000), 12},
    /* 35 */ {U64_C(0x2EE56725F06E5C71), 12},
    /* 36 */ {U64_C(0x41C21CB8E1000000), 12}
#endif
};

/* TODO: replace FPU related ops as it's overhead-monster inside the kernel.
 *
...
/* data type FILE is currently not used
...
*/
void apm_dump(const apm_digit *u,
              apm_size size,
              unsigned int radix,
              void __user *buf)
{
    ...
    char *p = apm_get_str(u, size, radix, str);
    ASSERT(p != NULL);
    copy_to_user(buf, p, string_size);
    FREE(str);
}
