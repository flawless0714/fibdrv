...
#define APM_DIGIT_HMASK U32_C(0xffff0000)
#define APM_DIGIT_LMASK U32_C(0x0000ffff)
...
#define APM_DIGIT_HMASK U64_C(0xffffffff00000000)
#define APM_DIGIT_LMASK U64_C(0x00000000ffffffff)
...
// void apm_fprint(const apm_digit *u, apm_size size, unsigned int radix, FILE
// *fp);
/*
 * Mostly same as above, except that this one dump the string into buffer at
 * usermode.
 */
